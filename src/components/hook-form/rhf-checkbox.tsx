...
export function RHFCheckbox({ name, helperText, label, slotProps, ...other }: CheckboxProps) {
...
export function RHFMultiCheckbox({ name, label, options, slotProps, helperText, ...other }: MultiCheckboxProps) {
  const { control } = useFormContext();
